...
/**
 * Precompiled plugin-librerias script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class PluginLibreriasPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_PluginLibrerias").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("plugin-java-core");
            target.getPluginManager().apply("java-library");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_PluginLibrerias").asSubclass(BasicScript.class);
